    ...
    <nav style={{ background: "#fff", borderBottom: "2px solid #e8f0fe", position: "sticky", top: 0, zIndex: 50, boxShadow: "0 2px 12px rgba(0,87,168,0.08)" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", height: 68, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          <img src="/logo.jpeg" alt="Aqua R.O Water Filter" style={{ width: 46, height: 46, objectFit: "contain", borderRadius: 8 }} />
          <div>
            <div style={{ color: "#0057a8", fontWeight: 900, fontSize: 18, letterSpacing: 0.5, lineHeight: 1.1 }}>Aqua R.O Water Filter</div>
